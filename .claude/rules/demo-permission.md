...
The demo driver (`mnemos-demo`) controls keyboard and mouse. Running it without permission:
...
Before running ANY demo command (`swift run mnemos-demo`, etc.):
...
- `swift run mnemos-demo`
- Any command in the `mnemos-demo` directory that launches the demo
